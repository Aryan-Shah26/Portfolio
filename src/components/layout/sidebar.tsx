    ...
    <aside className="fixed inset-y-0 left-0 z-40 hidden w-64 flex-col border-r border-border bg-sidebar lg:flex">
      ...
      <div className="flex flex-col gap-1 border-b border-border px-6 py-6">
        <Link href="/" className="group">
          <h1 className="text-lg font-bold tracking-tight text-foreground transition-colors group-hover:text-primary-light">
            ARYAN SHAH
          </h1>
        ...
        {NAV_ITEMS.map((item) => {
          ...
          return (
            <Link
              ...
              href={item.href}
              className={cn(
                "group flex items-center gap-3 rounded-none px-3 py-2.5 text-sm font-medium transition-all duration-200",
                isActive
